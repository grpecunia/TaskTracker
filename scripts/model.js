/**
 * backbone model definitions for TASKTRACKER
 */
 ...
 */
model.ProjectCollection = model.AbstractCollection.extend({
	url: 'api/projects',
...
/**
 * Task Backbone Collection
 */
model.TaskCollection = model.AbstractCollection.extend({
	url: 'api/tasks',
