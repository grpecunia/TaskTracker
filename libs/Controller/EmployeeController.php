...
class EmployeeController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Id,Fname,Lname,Email,PkColumn'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$employee->Id = $this->SafeGetVal($json, 'id');
			$employee->Fname = $this->SafeGetVal($json, 'fname');
			$employee->Lname = $this->SafeGetVal($json, 'lname');
			$employee->Email = $this->SafeGetVal($json, 'email');
			// this is an auto-increment.  uncomment if updating is allowed
			// $employee->PkColumn = $this->SafeGetVal($json, 'pkColumn');
	...
	public function Update()
	{
		try
		{
			...
			$employee->Id = $this->SafeGetVal($json, 'id', $employee->Id);
			$employee->Fname = $this->SafeGetVal($json, 'fname', $employee->Fname);
			$employee->Lname = $this->SafeGetVal($json, 'lname', $employee->Lname);
			$employee->Email = $this->SafeGetVal($json, 'email', $employee->Email);
			// this is a primary key.  uncomment if updating is allowed
			// $employee->PkColumn = $this->SafeGetVal($json, 'pkColumn', $employee->PkColumn);
