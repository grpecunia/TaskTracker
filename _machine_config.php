...
GlobalConfig::$CONNECTION_SETTING->DBName = "tasktracker";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "pecu1218";
...
/** the root url of the application with trailing slash, for example http://localhost/tasktracker/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'tasktracker/';
